import pytest
from delibere_comunali.parsing.entity_extractor import EntityExtractor, normalize_amount, normalizza_beneficiario
...
def test_extract_with_regex():
    ...
    Aggiudicatario Ditta Rossi S.R.L. per un importo di € 1.000,00.
    IBAN IT60X0542811101000000123456.
    Impegno n. 456. Capitolo 1234.
    """
    entities = extractor._extract_with_regex(text)
    
    assert entities['oggetto'] == "affidamento servizio con CIG Z123456789 e CUP A12B34567890123."
    ...
    assert entities['beneficiario'] == 'Rossi S.R.L.'
