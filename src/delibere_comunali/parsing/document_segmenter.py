...
class DocumentSegmenter:
    ...
    def __init__(self):
        ...
        self.section_patterns = {
            SectionType.INTESTAZIONE: {
                'keywords': [
                    r'Comune di', r'Albo Pretorio', r'N\.?\s*[0-9]+', r'Data\s+[0-9]{2}/[0-9]{2}/[0-9]{4}',
                    r'Determinazione', r'Delibera', r'Ordinanza', r'Decreto',
                    r'Oggetto:', r'Prot\.?\s*[0-9]+', r'Rep\.?\s*[0-9]+'
                ],
            ...
            SectionType.PREMESSA: {
                'keywords': [
                    r'Visto', r'Considerato', r'Richiamato', r'Atteso',
                    r'Dato atto', r'Preso atto', r'Ritenuto', r'Valutato',
                    r'Premesso che', r'In considerazione', r'Per le ragioni',
                    r'[Vv]isto', r'[Cc]onsiderato', r'[Rr]ichiamato'
                ],
                'start_weight': 0.9,
                'end_weight': 0.3,
            },
            SectionType.DISPOSITIVO: {
                'keywords': [
                    r'Determina', r'Delibera', r'Ordina', r'Dispone',
                    r'Impegna', r'Liquida', r'Affida', r'Assegna',
                    r'Autorizza', r'Approva', r'Respinge', r'Revoca',
                    r'[Dd]etermina', r'[Dd]ispone', r'[Ii]mpegna', r'[Ll]iquida'
                ],
                'start_weight': 0.95,
                'end_weight': 0.5,
            },
            SectionType.ALLEGATI: {
                'keywords': [
                    r'Allegato', r'Documentazione', r'PDF', r'File',
                    r'Si allega', r'Come da allegato', r'Documenti allegati',
                    r'[Aa]llegato'
                ],
                'start_weight': 0.8,
                'end_weight': 0.2,
            ...
            if new_section_type and new_section_type != current_section:
                ...
                if current_section and current_text:
                    ...
                    sections.append(DocumentSection(
                        ...
                        end_line=line_num - 1,
                        confidence=self._calculate_confidence(current_section, section_text)
                    ))
    ...
    def _merge_adjacent_sections(self, sections: List[DocumentSection]) -> List[DocumentSection]:
        """
    ...
    def get_section_text(self, sections: List[DocumentSection], section_type: SectionType) -> str:
        """
    ...
    def get_section_confidence(self, sections: List[DocumentSection], section_type: SectionType) -> float:
        """
...
class WeightedEntityExtractor:
    ...
    - Intestazione: Peso medio (metadati)
    ...
    def extract_with_weights(self, text: str, entity_extractor) -> Dict[str, Dict]:
        ...
        Returns:
            ...
            {
                "amounts": [{"value": 1000, "weight": 1.0, "section": "dispositivo"}, ...],
                "companies": [{"name": "Ditta X", "weight": 0.3, "section": "premessa"}, ...]
            }
        """
        ...
        for section in sections:
            ...
            # Assegna peso in base alla sezione
            weight = self.SECTION_WEIGHTS.get(section.section_type, 0.5)
    ...
    def get_high_confidence_entities(self, weighted_entities: Dict[str, Dict], min_weight: float = 0.7) -> Dict[str, List]:
        """
...
def segment_and_extract(text: str, entity_extractor) -> Tuple[List[DocumentSection], Dict[str, Dict]]:
    """
