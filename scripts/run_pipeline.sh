...
py -m delibere_comunali.parsing.analyze_albo --ente "$ENTE" --force --use-llm

echo "--- FASE 2: Report & Intelligence ---"
py scripts/build_knowledge_graph.py --base "$BASE_DIR"
py scripts/analyze_topology.py --base "$BASE_DIR"
py scripts/detect_anomalies.py --base "$BASE_DIR"
...
py scripts/train_model.py --base "$BASE_DIR"
